...
* 사용자 모드에서 시스템 콜 호출 시, 커널 모드로 전환 <br/>
  커널 모드에서 에서 시스템 콜 호출 시, 사용자 모드로 돌아가 작업 이어감
* 보통 직접적으로 시스템 콜을 사용하기보단 API(라이브러리 함수)를 통해 사용
<br/>
<img src ="https://img1.daumcdn.net/thumb/R1280x0/?scode=mtistory2&fname=https%3A%2F%2Fblog.kakaocdn.net%2Fdn%2FbR6eVn%2FbtrLzoAWyG7%2FkuPFQo2NrcnWpfrQideNzk%2Fimg.png">
